...
for item in PUX_COMPLETE:
    #print(PUX_COMPLETE[item]["id"], ":",definitions[item[:2]])
    print("ID:",definitions[item[:2]],item[2],"("+PUX_COMPLETE[item]["id"]+")")
    print("NAME:",PUX_COMPLETE[item]["name"])
    print("DEFINITION:",PUX_COMPLETE[item]["short_description"])
    print("\n")
